...
export default function Card({
	...
	const titleStorke = `
        ...
        `;
	const minHeight = 156;
	const diff = height - minHeight;
	const bdPath = `
        M3.485 ${46.0565 + diff / 2}
        V${45.8735 + diff / 2}
	...
	return (
		...
		>
			<div class="tw:absolute tw:left-0 tw:top-0 tw:w-full tw:z-2">
					...
					>
						...
						<g clip-path={`url(#clip0_70_69244${uid})`}>
							...
							<path
								...
								clip-rule="evenodd"
								d={`M10 0.5H165L175 10.5H${width}V34.5H0V10.5L10 0.5Z`}
								fill={`url(#paint1_linear_70_69244${uid})`}
							/>
							<path
								d={titleStorke}
								fill={`url(#paint2_linear_70_69244${uid})`}
								mask={`url(#path-2-inside-1_70_69244${uid})`}
							/>
							<g opacity="0.5">
								<mask
									id="mask0_70_69244"
									...
									height="29"
								>
									<g class="mix-blend-plus-lighter" opacity="0.8">
										<path
							...
							<g class="mix-blend-plus-lighter" opacity="0.1">
								<ellipse
									cx="81.5264"
									cy="12.5"
									rx="81.5264"
							...
							<g
								...
								clip-path={`url(#clip1_70_69244${uid})`}
							>
								<g class="mix-blend-plus-lighter" opacity="0.8">
									<ellipse
										cx="65"
								...
								<g class="mix-blend-plus-lighter" opacity="0.5">
									<ellipse
										cx="28.7857"
										cy="4.16667"
										rx="28.7857"
								...
								<g class="mix-blend-plus-lighter" opacity="0.54">
									<ellipse
										cx="23.2143"
										cy="2.16667"
										rx="23.2143"
						...
						<defs>
							...
							<clipPath id={`clip0_70_69244${uid}`}>
								<rect
									width={width}
									height="35"
									fill="white"
							...
							<clipPath id={`clip1_70_69244${uid}`}>
								<rect
									width="130"
									height="4"
									fill="white"
				...
				<img
					class="tw:absolute tw:right-3 tw:top-2.5 tw:w-40 tw:h-2"
					src="/assets/images/m-card/title-zs1.svg"
					alt=""
				/>
				<div
					class={cn(
						"tw:absolute tw:left-0 tw:top-0 tw:w-full tw:h-9",
						"tw:overflow-hidden tw:pointer-events-none",
					)}
				>
					<img
						src="/assets/images/m-card/saoguang.svg"
						alt=""
						class={cn(
                            "tw:absolute tw:left-0 tw:top-0 tw:z-1",
                            "tw:animate-[saoguangMove_6s_linear_infinite]"
                        )}
					/>
				</div>
				<div
					class={cn(
						"tw:absolute tw:left-5 tw:text-white tw:text-base",
						"tw:font-bold tw:tracking-[1.6px] tw:h-9 tw:leading-9",
						"tw:font-pingfang-sc tw:text-transparent",
						"tw:bg-gradient-to-b tw:from-[#DBF9FF] tw:to-[#A9F0FF] tw:bg-clip-text",
					)}
				>
					{title}
				</div>
			...
			<div
				class="tw:absolute tw:left-0 tw:top-0 tw:z-1"
				style={{ width: `${width}px`, height: `${height}px` }}
			>
				<div
				...
				>
					...
					<img
						class="tw:absolute tw:left-1 tw:bottom-1"
						src="/assets/images/m-card/content-bottom-left-arrow.svg"
						alt=""
					/>
					<img
						class="tw:absolute tw:right-1 tw:bottom-1"
						src="/assets/images/m-card/content-bottom-right-arrow.svg"
						alt=""
					/>
					<img
						class="tw:absolute tw:left-0 tw:top-1/2 tw:-translate-y-1/2"
						src="/assets/images/m-card/content-middle-line.svg"
						alt=""
					/>
					<img
				...
				<div
					class={cn(
						"tw:absolute tw:left-0 tw:top-9 tw:right-0 tw:bottom-0",
						"tw:pointer-events-auto tw:overflow-hidden",
					)}
				>
					{children}
				</div>
