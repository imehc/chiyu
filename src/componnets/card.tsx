...
export default function Card({ width = 398, height = 200, title = '标题', children }: CardProps) {
    ...
    return (
        <div class="m-card" style={{ width: `${width}px`, height: `${height}px` }}>
            <div class="m-card-hd">
                <div class="m-card-hd-bg">
                    <svg width={width} height="36" viewBox={`0 0 ${width} 36`} fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g clip-path={`url(#clip0_70_69244${uid})`}>
                            ...
                            />
                            <g class="mix-blend-plus-lighter" clip-path={`url(#clip1_70_69244${uid})`}>
                                <g class="mix-blend-plus-lighter" opacity="0.8">
                                    <ellipse
                                        cx="65"
                                        cy="2.16667"
            ...
            <div class="m-card-bd" style={{ width: `${width}px`, height: `${height}px` }}>
                <div class="m-card-bd-bg" style={{ width: `${width}px`, height: `${height}px` }}>
                    <svg
                        width={width}
                        height={height}
