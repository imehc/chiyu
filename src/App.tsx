...
const App: Component = () => {
  ...
  return (
    <div class="w-full h-screen bg-black z-1 relative top-0 right-0 bottom-0 left-0" ref={containerRef}>
      ...
      <div class="large-screen-wrap" id="large-screen">
        ...
        <div class="top-count-card">
          {state.statisticalCards.map((item) => <StatisticalCard {...item} />)}
        </div>
        {/* 左边布局 图表 */}
        <div class="left-wrap">
